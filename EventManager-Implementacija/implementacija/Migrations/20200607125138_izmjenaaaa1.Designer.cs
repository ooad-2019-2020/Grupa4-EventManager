...
namespace implementacija.Migrations
{
    ...
    [Migration("20200607125138_izmjenaaaa1")]
    partial class izmjenaaaa1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("implementacija.Models.Registracija", b =>
                {
            ...
            modelBuilder.Entity("implementacija.Models.Registracija", b =>
                {
                    b.HasOne("implementacija.Models.FizickoLice", "FizickoLice")
                        .WithMany()
                    ...
                    b.HasOne("implementacija.Models.VIP", "VIP")
                        .WithMany()
                        .HasForeignKey("VIPId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
